...
//as letras sao passadas para maiuscula, para que sejam aceitas tanto letras maiusculas como minusculas
    ...
    else if(linha2 == linha1 && Math.abs(coluna2 - coluna1) == 1){
        return true;
    }
    else if(coluna2 == coluna1 && Math.abs(linha2 - linha1) == 1){
        return true;
    }
    else if(Math.abs(linha2 - linha1) == 1 && Math.abs(coluna2 - coluna1) == 1){
        return true;
    }
    else {
        return false;
